...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="text" @readonly(true) name="slug" value="{{ $category->slug }}" id="slug" class="form-control" placeholder="Slug">	
            <p></p>
        </div>
    </div>	
    <div class="col-md-6">
    ...
    <div class="dz-message needsclick">    
        ...
        <div>
            <img with="200px" height="200px" src="{{ asset('uploads/category/'.$category->image) }}">
        </div>
        @endif
    </div>
    <div class="col-md-6">
    ...
    <div class="col-md-6">
        <div class="mb-3">
            <label for="status"><S></S>how on Home</label>
